...
# about which groups appear. Under Site or Owner a location's use case is
# one input among several, not the thing the group is.
...
class HorseListView(FeatureAccessMixin, ListView):
    ...
    def shows_use_filter(self):
        return self.group_by in AXES_WITH_USE_FILTER
