...
urlpatterns = [
    ...
    path('settings/services/add/', service_item_create, name='service_item_create'),
    path('settings/services/<int:pk>/edit/', service_item_update, name='service_item_update'),
