...
urlpatterns = [
    ...
    path('breeding/<int:pk>/watch/', views.breeding_watch_update, name='breeding_watch_update'),
    path('breeding/<int:pk>/foal/', views.breeding_foal_edit, name='breeding_foal_edit'),
    path('breeding/<int:pk>/wean/', views.breeding_wean, name='breeding_wean'),
    path('breeding/<int:pk>/foal/notes/add/', views.breeding_foal_note_add, name='breeding_foal_note_add'),
    path('breeding/foal/notes/<int:pk>/delete/', views.breeding_foal_note_delete, name='breeding_foal_note_delete'),
